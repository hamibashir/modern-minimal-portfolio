export const personalInfo = {
  ...
  bio: "I'm a full-stack software engineer with 1+ years of experience crafting elegant solutions across mobile, web, and backend domains. I love transforming complex problems into clean, intuitive applications.",
...
export const skillCategories: SkillCategory[] = [
  ...
  {
    title: "DevOps & Tools",
    description: "Infrastructure and cloud platforms",
    icon: "cloud",
    emoji: "☁️",
